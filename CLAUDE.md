...
that work. Ash skips mm-t43 and the two
...
`bd ready -t epic -l second-cut --exclude-label human`. Plain `bd ready` also lists
...
for each of the twelve constraint beads (`bd list -l constraint --all`). The
