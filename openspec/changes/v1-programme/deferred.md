...
| widgets-and-intents | every requirement | Entry points are the app only; no widget, intent, control, snapshot or queue | 2.5 widgets-and-intents |
| app-lock | Entry points ask before they show anything | Vacuous until 2.5 | 2.5 widgets-and-intents |
...
| programme | Stages 3 to 7 tools | Rows show their opening rule; no tool opens beyond stage 2 | 3.1 to 3.6 |
...
| weekly-review | Taking stock and the questionnaire | The review of week 6 is a plain review | 3.2 second part, with 3.4 and 3.5 |
| dieting-module | every requirement | Absent | 3.4 food-rules |
| body-image-module | every requirement | Absent | 3.5 body-image-module |
| staying-on-track | every requirement except "Start week 1 again" | Absent | 3.6 staying-on-track |
