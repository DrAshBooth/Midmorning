...
- [ ] 4.3b App Store submission, not a build change: the demo video of every stage, the background modes and their review-notes lines, and the gates for the launch build. The gates include one clinical walk of the after-binge paths before the launch build (decision 101). Ash does it after the second-cut build changes.
