...
final class DiscreetTextByDefaultTests: XCTestCase {
    ...
    func testADiscreetPlannedMealReminder() {
        XCTAssertEqual(DiscreetText.title(kind: .plannedMeal, explicitWordingOn: false, slotLabel: "Lunch"), "")
    ...
    func testAnExplicitPlannedMealReminder() {
        XCTAssertEqual(DiscreetText.title(kind: .plannedMeal, explicitWordingOn: true, slotLabel: "Mid-morning"), "Mid-morning")
    ...
    func testAnExplicitReminderForARenamedSlot() {
        XCTAssertEqual(DiscreetText.title(kind: .plannedMeal, explicitWordingOn: true, slotLabel: "Elevenses"), "Elevenses")
    }

    /// Scenario: A renamed slot with explicit wording off.
    func testARenamedSlotWithExplicitWordingOff() {
        XCTAssertEqual(DiscreetText.title(kind: .plannedMeal, explicitWordingOn: false, slotLabel: "Elevenses"), "")
    }

    /// Scenario: An explicit close-the-day reminder.
    func testAnExplicitCloseTheDayReminder() {
        XCTAssertEqual(DiscreetText.title(kind: .closeTheDay, explicitWordingOn: true), "Close the day")
    ...
    func testAnExplicitCheckInReminderTitle() {
        XCTAssertEqual(DiscreetText.title(kind: .checkIn, explicitWordingOn: true), "Check-in")
    }
