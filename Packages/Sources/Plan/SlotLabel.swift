...
public enum SlotLabel {
    ...
    /// empty, otherwise the slot's default label.
    public static func effective(stored: String?, defaultLabel: String) -> String {
    ...
    public static let productNameMessage = "That is the app's name. Choose another word."
